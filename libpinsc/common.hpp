...
struct ps_errs_ {
    ...
    int ACCESS_DENIED        = -6;
    int FILE_EXISTS          = -7;
    int DIRECTORY_EXISTS     = -8;
    int DIRECTORY_NOT_EMPTY  = -9;
    int FILE_NOT_FOUND       = -10;
    int DIRECTORY_NOT_FOUND  = -11;
    int DOWNLOAD_FAIL        = -12;
    int DOWNLOAD_SAVE_FAIL   = -13;
    int TOO_MANY_ARGUMENTS   = -14;
    int NOT_A_REGULAR_FILE   = -15;
    int NOT_A_DIRECTORY      = -16;
    int IS_DIRECTORY         = -17;
    int ATTR_LIMIT_REACHED   = -18;
    int ATTR_NOT_FOUND       = -19;
